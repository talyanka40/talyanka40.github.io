...
$(document).ready(function () {
	...
	$('.menu div.portfolio1-btn').on('click', function () {
        $('.portfolio1-page').fadeIn(1200);
    });
    ...
    $('.close-btn').on('click', function () {
        ...
        $('.profile-page, .resume-page, .portfolio-page, .portfolio1-page, .contact-page').fadeOut(800);
    });
